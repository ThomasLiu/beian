...
var styles = {
  'popover': 'u_webant-notice-icon-popover',
  'noticeButton': 'u_webant-notice-icon-noticeButton',
  'icon': 'u_webant-notice-icon-icon',
  'tabs': 'u_webant-notice-icon-tabs',
  'ant-tabs-nav-scroll': 'u_webant-notice-icon-ant-tabs-nav-scroll',
  'ant-tabs-bar': 'u_webant-notice-icon-ant-tabs-bar'
};
