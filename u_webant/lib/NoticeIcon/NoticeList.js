...
var styles = {
  'list': 'u_webant-notice-icon-list',
  'item': 'u_webant-notice-icon-item',
  'meta': 'u_webant-notice-icon-meta',
  'avatar': 'u_webant-notice-icon-avatar',
  'iconElement': 'u_webant-notice-icon-iconElement',
  'read': 'u_webant-notice-icon-read',
  'title': 'u_webant-notice-icon-title',
  'description': 'u_webant-notice-icon-description',
  'datetime': 'u_webant-notice-icon-datetime',
  'extra': 'u_webant-notice-icon-extra',
  'notFound': 'u_webant-notice-icon-notFound',
  'clear': 'u_webant-notice-icon-clear'
};
